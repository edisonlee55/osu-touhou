...
{
    public class TouhouBackground : CompositeDrawable
    {
        ...
        {
            config.BindWith(TouhouRulesetSetting.Background, bgType);
            config.BindWith(TouhouRulesetSetting.PlayfieldDim, bgDim);
        }
