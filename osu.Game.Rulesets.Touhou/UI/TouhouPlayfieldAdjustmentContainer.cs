...
{
    public class TouhouPlayfieldAdjustmentContainer : PlayfieldAdjustmentContainer
    {
        ...
        public TouhouPlayfieldAdjustmentContainer()
        {
        ...
        private class ScalingContainer : Container
        {
            protected override void Update()
            {
                ...
                // Scale = 819.2 / 512
                // Scale = 1.6
                Scale = new Vector2(Parent.ChildSize.X / TouhouPlayfield.BASE_SIZE.X);
                // Size = 0.625
